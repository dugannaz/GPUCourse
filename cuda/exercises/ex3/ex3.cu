...
/* Simple Cuda program - Coalesced access version
 * - Coalesced global memory access
 * - Effect of kernel execution parameters on coalescing
 * - Optional: Data alignment - coalescing  
 */
...
__global__ void addOne1(int n, double *data) {
	...
	// (*) modify the loop for coalesced access
